...
function FirstLoad({containerRef}) {
    return (
        <div className=''>
            <div className='relative h-[100vh] w-full flex items-center justify-center'>
                <div className='flex flex-col md:flex-row-reverse mx-auto max-w-[1280px] w-full justify-center z-1 bg-transparent'>
                    <img src="/images/nx_wave_hero.png" alt="card_asset" className="h-auto w-[225px] md:w-[420px] md:h-[420px] max-w-[420px] z-[1] mx-6" />
                    <div className='z-10 w-full mt-7 md:mt-0 md:my-auto flex flex-col self-end md:self-center px-6'>
                        <h1 className="font-normal max-w-[300px] md:max-w-[700px] text-3xl md:text-[3.4rem] md:leading-[54px] text-black md:mb-6 "><span><strong>NX Wave.</strong> The next-gen credit card for those who love rewards.</span></h1>
                ...
                <video autoPlay muted loop playsInline className='absolute w-[100vw] h-[100vh] object-cover top-0 left-0 right-0 bottom-0 z-0 '>
